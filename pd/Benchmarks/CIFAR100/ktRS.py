...
from pd import utils
from pd.Benchmarks.ktRSUtils import ktRS_parameters, define_tuner, train_model, evaluation, graph_history
...
def main():
	...
	for i in range(len(training_parameters.SEED)):
		...
		train_loss, test_loss = evaluation.evaluate_model(model, dataset, training_parameters.batch_size)
